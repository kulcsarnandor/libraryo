...
ALLOWED_HOSTS = ['libraryo.onrender.com', 'www.libraryo.onrender.com']
...
# render-ben at van teve environment variable production -re.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pages.context_processors.authors_processor',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = 'Library-O <nkulcsarn@gmail.com>'
